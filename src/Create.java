    ...
    public static void create() {
        try {
            ...
            if (!databaseExists)
            {
                ...
                //CREATE TABLE FINES
                stmt.executeUpdate("CREATE TABLE FINES(LOAN_ID INT NOT NULL PRIMARY KEY, FINE_AMOUNT INT, PAID BOOLEAN DEFAULT FALSE, FOREIGN KEY (LOAN_ID) REFERENCES BOOK_LOANS(LOAN_ID))");
                resultSet.close();
            }
        }
